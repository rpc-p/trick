...
const { log, ing, success, warning, error  } = require('../utils/logger');

const cfgPath = path.resolve('./trick.json');
const packageJsonPath = path.resolve('./package.json');

function compress(version, cmd) {
  // console.log(version, cmd)

  // const cfg = fse.readJSONSync(cfgPath);
  ...
  //     appendJson(cfgPath, { compress: Object.assign({}, compress, { minorversion: nextVersion }) });

  //     // update package.json
  //     appendJson(packageJsonPath, {
